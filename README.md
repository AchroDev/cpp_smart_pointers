...
<br />
<div align="center">
  <a href="https://github.com/AchroDev/cpp_smart_pointers">
    <img src ="resources/c++.svg" alt="Logo" width="150" height="150">
  </a>
<h3 align="center"> C++ Smart Pointers ~ AchroDev </h3>

  <p align="center">
    How Smart Pointers (std::unique_ptr, std::shared_ptr, std::weak_ptr) work in C++
    <br />
  </p>
</div>
...
This project goes over how Smart Pointers in C++ work, following The Cherno.
